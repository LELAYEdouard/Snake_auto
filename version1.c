...
void ajouterPomme(tPlateau plateau,int i);
...
void disable_echo();
void enable_echo();
char trouverPomme(int lesX[], int lesY[], int pomX, int pomY); // Fonction permettant de trouver les pommes
...
int main(){
	...
	do {
		direction = trouverPomme(lesX, lesY, lesPommesX[nbPommes], lesPommesY[nbPommes]);
...
// Cette fonction détermine la direction que le serpent doit prendre pour atteindre une pomme.
// Elle compare les coordonnées actuelles de la tête du serpent (lesX[0], lesY[0]) 
// avec les coordonnées de la pomme (pomX, pomY).
// - Si la tête du serpent est à gauche de la pomme, il doit se déplacer à DROITE.
// - Si la tête du serpent est à droite de la pomme, il doit se déplacer à GAUCHE.
// - Si la tête du serpent est au-dessus de la pomme, il doit se déplacer en BAS.
// - Si la tête du serpent est en dessous de la pomme, il doit se déplacer en HAUT.
// La direction à prendre est renvoyée sous forme de caractère.
char trouverPomme(int lesX[], int lesY[], int pomX, int pomY) {
	char direction;
